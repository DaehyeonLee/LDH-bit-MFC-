...
// 축소판 그림을 지원합니다.
void CKEYDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CKEYDoc::InitializeSearchContent()
{
...
void CKEYDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
