...
// LineDrawing.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BOOL CLineDrawingApp::InitInstance() //전체 어플리케이션 초기화
{
...
int CLineDrawingApp::ExitInstance() //끝날때
{
	// TODO: 여기에 특수화된 코드를 추가 및/또는 기본 클래스를 호출합니다.
	GdiplusShutdown(m_gdiplusToken); //반드시 반납
